...
import com.ray.pi.common.utils.PropertiesLoader;
...
public class Global {
	...
	/**
	 * 给图片到到项目外边、或者设置userfiles.basedir
	 */
	public static final String USERFILES_PLUS = "_upload";
	/**
	 * 获取当前对象实例
	 */
...
//				/*chengj */
//				dir = dir + Global.USERFILES_PLUS;  //给图片到到项目外边、或者设置userfiles.basedir
//
//			} catch (Exception e) {
//				return "";
//			}
