 ...
 * v2.3.1 http://twitter.github.com/bootstrap/javascript.html#transitions
...
!function($) {
		...
		return this.each(function() {
			var $this = $(this), data = $this.data('carousel'), options = $
					.extend({}, $.fn.carousel.defaults,
							typeof option == 'object' && option), action = typeof option == 'string'
					? option
					: options.slide
			if (!data)
	...
	$(document).on('click.carousel.data-api', '[data-slide], [data-slide-to]',
			function(e) {
...
!function($) {
	...
	Modal.prototype = {
		...
		backdrop : function(callback) {
			var that = this, animate = this.$element.hasClass('fade')
					? 'fade'
					: ''
...
!function($) {
	...
	Tooltip.prototype = {
		...
		,
		toggle : function(e) {
			var self = e ? $(e.currentTarget)[this.type](this._options)
					.data(this.type) : this
...
!function($) {
	...
	Typeahead.prototype = {
		...
		,
		keydown : function(e) {
			this.suppressKeyPressRepeat = ~$.inArray(e.keyCode, [40, 38, 9, 13,
							27])
			this.move(e)
		}
...
!function($) {
	...
	Affix.prototype.checkPosition = function() {
		...
		this.$element.removeClass(reset).addClass('affix'
				+ (affix ? '-' + affix : ''))
	}
