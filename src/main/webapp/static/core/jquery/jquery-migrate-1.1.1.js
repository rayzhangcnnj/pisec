 ...
 * https://github.com/jquery/jquery-migrate Copyright 2005, 2013 jQuery
 * Foundation, Inc. and other contributors; Licensed MIT
 */
(function(jQuery, window, undefined) {
			...
			if (fragment) {
				...
				handleScript = function(elem) {
					...
					if (!elem.type || rscriptType.test(elem.type)) {
						...
						return scripts ? scripts.push(elem.parentNode
	...
	var eventAdd = jQuery.event.add, eventRemove = jQuery.event.remove, eventTrigger = jQuery.event.trigger, oldToggle = jQuery.fn.toggle, oldLive = jQuery.fn.live, oldDie = jQuery.fn.die, ajaxEvents = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", rajaxEvent = new RegExp("\\b(?:"
			+ ajaxEvents + ")\\b"), rhoverHack = /(?:^|\s)hover(\.\S+|)\b/, hoverHack = function(
			events) {
					...
					setup : function() {
						...
						if (elem !== document) {
							jQuery.event.add(document,
									name + "." + jQuery.guid, function() {
										jQuery.event.trigger(name, null, elem,
												true);
									});
